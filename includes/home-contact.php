<!-- ====== Contact Start ====== -->
<section id="kapcsolat" class="py-20 md:py-[120px] relative">
    <div class="
          absolute
          z-[-1]
          w-full
        ...
        <div class="flex flex-wrap items-center -mx-4">
                ...
                <div class="ud-contact-content-wrapper">
                    ...
                    <div class="flex flex-wrap justify-between mb-12 lg:mb-0">
                        <div class="flex max-w-full w-[330px] mb-8">
                            ...
                            <div>
                                <h5 class="text-lg font-semibold mb-6">Címünk</h5>
                                <p class="text-base text-body-color">
                                    2310 Szigetszentmiklós, Kardos István u. 35.
                                </p>
                            </div>
                        </div>
                        <div class="flex max-w-full w-[330px] mb-8">
                            ...
                            <div>
                                <h5 class="text-lg font-semibold mb-6">Email címünk</h5>
                                <p class="text-base text-body-color">m0ponyvakft@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-4 w-full lg:w-5/12 xl:w-4/12">
              ...
              ">
                    ...
                    <iframe src="https://snazzymaps.com/embed/380374" width="100%" height="600px" style="border:none; border-radius: 6px;" class="mx-auto lg:ml-auto"></iframe>
                </div>
            </div>
        </div>
    </div>
