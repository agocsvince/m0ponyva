            ...
            <div class="w-full px-4">
              ...
              " data-wow-delay=".2s">
                ...
                ">
                  ...
                  max-w-[600px]
                ">
                        Kamionok, teherautók, utánfutók, terasz, kerthelyiségek,
                        kocsibeállók, tárolók, hajók, árnyékolók ponyvázása és egyedi ponyva készítés.
                    </p>
                    <ul class="flex flex-wrap items-center justify-center mb-10">
                        <li>
                            <a href="tel:+36706683014" class="
                      py-4
                      px-6
                      sm:px-10
                      inline-flex
                    ...
                    ">
                        ...
                        <li>
                            <a href="szolgaltatasok.html" target="_blank" class="
                      text-base
                      font-medium
                      text-white
                      py-4
